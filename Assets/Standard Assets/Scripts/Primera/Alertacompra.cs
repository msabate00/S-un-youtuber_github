...
public class Alertacompra : MonoBehaviour {

    public static string Quien = "Teletienda";
    public static string Desmone = "No tiene dinero para realizar la autocompra";
    public static string Desmonexp = "No se ha podido efectuar la autocompra debido a que no dispone del dinero suficiente para realizar la transacción.";
    void Start () {
    ...
    void Conversor18()
    {
        ...
        GetComponent<Alertacompra>().enabled = false;
    }
}
