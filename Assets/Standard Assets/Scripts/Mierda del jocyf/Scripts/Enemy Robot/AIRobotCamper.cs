...
public class AIRobotCamper : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        anigay = gameObject.GetComponent<Animator>();
       ...
       // FirePos.LookAt(target);
        ...
        switch (state)
        {
            ...
            case AIState.Guard:
                ...
                if (angle >= shootAngle) // Añadido de rotacion en parado.
                {
            ...
            case AIState.Golpiado:
                Debug.Log("TU PUTATATDSARMTKLSDAMTSA");
                speed = 0;
    ...
    public void AttackPlayerStatic()
    {
        ...
        if (this.CanSeeTarget())
        {
            ...
            speed = 0;
            if (!anigay.GetCurrentAnimatorStateInfo(0).IsName("apuntando"))
            {
                Animasion.SetSpeed("apunta");
                speed = 0;
            }
        ...
        else
        {
            ...
            ChaseTimeCheck = Time.time + GuardTime;
    ...
    private void StartChaseStatus()
    {
        if (state != AIState.Patrol)
        {
            ...
            beingStopped = false;
            speed = this.runSpeed;
            ChaseTimeCheck = Time.time + this.AturdidoTime;
            state = AIState.Chase;
        }
